...
Imagine this project as something like Evan Chen's [Infinitely Large Napkin](https://web.evanchen.cc/napkin.html), where a practically indefinite amount of space and time is available at my disposal to attempt to address as many computational perception questions as I can.
...
* [00 Setup](/src/00-Setup) - how to start developing, building, and running a sketch, given access to a PC.
* [01 Language](src/01-Language) - how to translate basic ideas into code.
* [02 Theory](src/02-Theory) - techniques for processing data.
